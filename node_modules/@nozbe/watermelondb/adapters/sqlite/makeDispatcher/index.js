...
var makeDispatcher = function (type, tag) {
  var methods = dispatcherMethods.map(function (methodName) {
    ...
    return [methodName, function (...args) {
      ...
      if ('synchronous' === type) {
        // $FlowFixMe
        callback((0, _common2.syncReturnToResult)(_DatabaseBridge.default[name].apply(_DatabaseBridge.default, [tag].concat((0, _toConsumableArray2.default)(otherArgs)))));
      } else {
        var promise = new Promise(function (resolve, reject) {
          // $FlowFixMe
          _DatabaseBridge.default[name].apply(_DatabaseBridge.default, [tag].concat((0, _toConsumableArray2.default)(otherArgs), [resolve, function (code, message, error) {
            reject(error);
          }]));
        });

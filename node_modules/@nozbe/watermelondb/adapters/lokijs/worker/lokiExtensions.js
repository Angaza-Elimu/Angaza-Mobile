...
function getLokiAdapter(options) {
  return new Promise(function ($return, $error) {
    var useIncrementalIndexedDB, adapter, onQuotaExceededError, onIndexedDBVersionChange, onIndexedDBFetchStart, dbName, serializer, IncrementalIDBAdapter, LokiIndexedAdapter;
    ({
...
function newLoki(options) {
  return new Promise(function ($return, $error) {
    ...
    return Promise.resolve(getLokiAdapter(options)).then(function ($await_3) {
      try {
        loki = new _lokijs.default(options.dbName, {
          adapter: $await_3,
          autosave: autosave,

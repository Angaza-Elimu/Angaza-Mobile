...
function () {
  ...
  _proto.extend = function extend(...clauses) {
    ...
    })), (0, _toConsumableArray2.default)(where), (0, _toConsumableArray2.default)(sortBy), (0, _toConsumableArray2.default)(take ? [Q.experimentalTake(take)] : []), (0, _toConsumableArray2.default)(skip ? [Q.experimentalSkip(skip)] : []), (0, _toConsumableArray2.default)(lokiFilter ? [Q.unsafeLokiFilter(lokiFilter)] : []), clauses));
  };
  ...
  return Query;
}(), _temp), (_descriptor = (0, _applyDecoratedDescriptor2.default)(_class.prototype, "_cachedSubscribable", [_lazy.default], {
  configurable: true,
  enumerable: true,
  writable: true,
